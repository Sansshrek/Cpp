...
int cornici(int scelta){
    //check spazi liberi alle cornici
    int n = rand()%4;
    cout<<"\nCornici scelta="<<n<<endl;
    if(n==0){
        if(tris[0]==" ")  //pos 1 libera
            return 1;
        else{
            n = rand()%3;
            if(n==0){
                if(tris[2]==" ")  //pos 3 libera
                    return 3;
                else{
                    n = rand()%2;
                    if(n==0){
                        if(tris[6]==" ")  //pos 7 libera
                            return 7;
                        else if(tris[8]==" ")  //pos 9 libera
                            return 9;
                    }
                    else{
                        if(tris[8]==" ")  //pos 9 libera
                            return 9;
                        else if(tris[6]==" ")  //pos 7 libera
                            return 7;
                    }
                }
            }
...
int lati(int scelta){
    ...
    cout<<"\nCornici scelta="<<n<<endl;
    if(n==0){
        if(tris[1]==" ")  //pos 2 libera
            return 2;
        else{
            n = rand()%3;
            if(n==0){
                if(tris[3]==" ")  //pos 4 libera
                    return 4;
                else{
                    n = rand()%2;
                    if(n==0){
                        if(tris[5]==" ")  //pos 6 libera
                            return 6;
                        else if(tris[7]==" ")  //pos 8 libera
                            return 8;
                    }
                    else{
                        if(tris[7]==" ")  //pos 8 libera
                            return 8;
                        else if(tris[5]==" ")  //pos 6 libera
                            return 6;
                    }
                }
            }
...
int checkPC(){
    ...
    int sceltaMossa=rand()%3,mossa;
    if(sceltaMossa==0){   //cornici
        if(tris[0]==" " && tris[2]==" " && tris[6]==" " && tris[8]==" ")
            mossa=cornici(sceltaMossa);
        else{
            sceltaMossa=rand()%2;
            if(sceltaMossa==0){   //centro
                if(tris[4]==" ")
                    mossa=centro(sceltaMossa);
            }
            else{   //lati
                if(tris[1]==" " && tris[3]==" " && tris[5]==" " && tris[7]==" ")
                    mossa=lati(sceltaMossa);
            }
        }
    }
    else if(sceltaMossa==1){  //centro
        if(tris[4]==" ")
            mossa=centro(sceltaMossa);
        else{
            sceltaMossa=rand()%2;
